...
<%
    ...
    try {
        ...
        String sql = "SELECT DISTINCT flightcode, flightname, flighturl, flightdescr, flightfrom, flightto, flightdeparturedate, flightarrivaldate, priceone, pricetwo, pricethree " +
                 "FROM flighttb " +
                 "WHERE flightfrom = ? AND flightto = ? " +
                 "AND flightdeparturedate >= ? " + // Filter by departure date
                 "AND flightarrivaldate <= ? AND flightdeparturedate >= ?" + // Filter by return date
      ...
      <!-- Use SweetAlert to display the message -->
        <script>
            ...
            Swal.fire({
                ...
                text: 'No flights found based on your search criteria.',
