        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid dashboard-content">
              ...
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Generate Passenger List</h5>
                                <div class="card-body">
                                    <form action="" method="GET"> <!-- Changed action to a new JSP -->
                                        <div class="form-row">
                                            ...
                                            <div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 col-12 mb-2">
                                              <label for="fromDate">Pay Status: </label>
                                            ...
                                            <div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 col-12 mb-2">
                                              <label for="fromDate">Book Status: </label>
                                            ...
                                            <% 
                                                ...
                                                try {
                                                    ...
                                                    if (fromDate != null && toDate != null) {
                                                        ...
                                                        String sql = "SELECT * FROM bookingtb WHERE bookstatus=? AND paymentStatus=? AND doneon BETWEEN ? AND ?";
