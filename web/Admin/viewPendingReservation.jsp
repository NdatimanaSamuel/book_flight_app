            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">All Canceled Booking </h5>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <% 
                                                ...
                                                try {
                                                    ...
                                                    rs = stmt.executeQuery("SELECT * FROM bookingtb WHERE bookstatus = 'pending' ORDER BY bookingid DESC");
                                            ...
                                            <tr>
                                                ...
                                                <a href="ApproveBooking.jsp?id=<%= rs.getInt("bookingid") %>&email=<%= rs.getString("email") %>" class="btn btn-warning">Approve</a>
                                            </td>

                                                 <td>
                                                    <a href="RejectBooking.jsp?id=<%= rs.getInt("bookingid") %>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this user?');">Reject</a>
                                                </td>
